...
# Vertical
dividerHeight = raw_input('How many coloumns: ')
...
# Horizontal
dividerWidth = raw_input('How many rows: ')
...
while (h < len(heightValues)):
	...
	while (w < len(widthValues)):
		...
		cropped_img = img[heightValues[x]:heightValues[w],widthValues[y]:widthValues[h]]
