...
if __name__ == '__main__':
	try:
		...
		setpoint_pos_local = rospy.Publisher('mavros/setpoint_raw/local', PositionTarget ,queue_size=1)
		...
		isModeChanged = setHomeService(current_gps=True, latitude=0.0, longitude=0.0, altitude=0.0)
		time.sleep(2)
		print isModeChanged
